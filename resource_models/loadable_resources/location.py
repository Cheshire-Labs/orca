...
class Location(IUseable, IResource, ILabwareLoadable):
    ...
    @property
    def resource(self) -> Optional[BaseResource]:
        return self._resource

    def __init__(self, name: str) -> None:
        self._name = name
        self._reserved = False
        self._resource: Optional[BaseResource] = None
        self._can_resolve_deadlock = True
        self._options:  Dict[str, Any] = {}
        self._init_options: Dict[str, Any] = {}
        self._labware: Optional[Labware] = None

    def set_resource(self, resource: BaseResource, can_resolve_deadlock: bool = False) -> None:
