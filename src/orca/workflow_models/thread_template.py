...
from orca.workflow_models.labware_thread import IThreadObserver, Method
...
class ThreadTemplate:
    ...
    def __init__(self, labware_template: LabwareTemplate, start: Location, end: Location, methods: List[IMethodTemplate] = [], observers: List[IThreadObserver] = []) -> None:
